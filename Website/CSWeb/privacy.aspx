<%@Page Language="C#" AutoEventWireup="true" Inherits="CSWeb.Root.Store.privacy" EnableSessionState="True" %>
 ...
 <div id="home_left" class="otherleft">
   <div id="left_txt">
     ...
     <p><strong>Unforeseen Circumstances</strong><br />
       In the event that we, or any of our businesses, are sold or disposed of as a going concern, whether by merger, sale of assets or otherwise, or in the event of an insolvency, bankruptcy or receivership, personally identifiable information of visitors to our Site and customers may be one of the assets sold or merged in connection with that transaction. Personal information may also need to be disclosed in connection with a commercial transaction where we or any one of our businesses are seeking financing, investment, support or funding. In such transactions, personal information may be one of the transferred assets.</p>
     <p>A Note To International Users. The Website is hosted in the United States. If you are using the Website from outside the United States, by providing your information to the Websites, you are consenting to the transfer of your information to the United States for processing and maintenance in accordance with this Privacy Policy and our Terms of Use. You are also consenting to the application of United States law in all matters concerning the Websites.</p>
     ...
     <p><strong>Contact Us</strong><br />
       Please relay any questions you may have pertaining our above stated policies to our Customer Service Department via email by clicking <a href="mailto:bellaplexsupport@bellaplexdirect.com">here</a> or by calling 1-800-672-2259 or sending a letter to:</p>
     <p>Urban Nutrition<br />
       930 Newark Ave<br />
       Jersey City, NJ 07306<br />
       Attn: Customer Relations and Compliance </p>
     <p><br />
     </p>
   </div>
 </div>
