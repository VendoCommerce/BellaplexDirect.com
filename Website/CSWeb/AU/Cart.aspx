...
<div class="content">
<div class="checkout_header"><img src="https://dd991rkqr6iba.cloudfront.net/Images/header.gif" width="912" height="101" alt="Thinning hair solution for women" /></div>
<div class="center_content">
      <div class="checkout_left">
    <div class="orderDetails">
          <div class="orderTitle">
        <h2>Trial Offer Review</h2>
      </div>
          <div class="orderProduct orderPadding"> <img class="product" alt="Keranique thinning hair solution" src="https://dd991rkqr6iba.cloudfront.net/Images/product_cc_b2.jpg">
...
<img class="product" width="93" height="99" alt="Fortifying Mousse and daily essentials" src="https://dd991rkqr6iba.cloudfront.net/Images/gift_cc_b2.jpg">
<div class="contentProduct">
<h4 style="width: 260px;">
<span class="highlight">Order Today</span>
and receive a FREE bottle of Fortifying
Mousse as our gift to you!
</h4>
</div>
<div class="priceProduct">
...
<div class="shipping_price" style="width: 250px; float:right; padding-top: 10px;">
<table width="100%" border="0">
  <tr>
    <td align="right" style="padding-right: 15px; padding-bottom: 12px;"><strong>Shipping and Processing:</strong></td>
    <td style="padding-bottom: 12px">$7.95</td>
  </tr>
  <tr>
    <td align="right" style="padding-right: 15px;"><strong>Your total today:</strong></td>
    <td>$7.95</td>
  </tr>
</table>
</div>
...
<div id="redeem_toggle2" style="display:none">
 <div class="orderCode">
<img src="https://dd991rkqr6iba.cloudfront.net/Images/redeemed.gif">
...
<table width="100%" border="0">
  <tr>
    <td align="right" style="padding-right: 15px; padding-bottom: 12px;"><strong>Shipping and Processing:</strong></td>
    <td style="padding-bottom: 12px">$3.95</td>
  </tr>
  <tr>
    <td align="right" style="padding-right: 15px;"><strong>Your total today:</strong></td>
    <td>$3.95</td>
