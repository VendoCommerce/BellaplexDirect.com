...
namespace CSWeb.AU.UserControls
{
   public partial class RangeDateControl : UserControl
   {
      ...
      private string ClientScriptGenerator()
      {
         ...
         sb.Append(" document.getElementById(startDateControl).value = '" + DateTimeUtil.WeekFirstDay(DateTime.Now).ToShortDateString() + "'; \n");
         sb.Append(" document.getElementById(endDateControl).value = '" + DateTimeUtil.WeekLastDay(DateTime.Now).ToShortDateString() + "'; \n");
