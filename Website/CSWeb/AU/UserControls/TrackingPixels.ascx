<%@Control Language="C#" AutoEventWireup="true" CodeBehind="TrackingPixels.ascx.cs" Inherits="CSWeb.AU.UserControls.TrackingPixels" %>
...
<script language="JavaScript" type="text/javascript">    var __tsaapi__ = __tsaapi__ || [];
    __tsaapi__.push(function () {
        ...
        <asp:Literal ID="LiteraltotalChargedMainItem" Visible="false" runat="server"></asp:Literal>

        <!-- Form Code -->
        <form name="flgxfrm">
        <input type="hidden" name="id" value="<%=LiteralID.Text.Trim() %>">
        <input type="hidden" name="sid" value="<%=LiteralSid.Text.Trim() %>">
        <input type="hidden" name="offerID" value="<%=LiteralOfferId.Text.Trim() %>">
        <input type="hidden" name="uniqueID" value="<%=CurrentOrder.AttributeValues["customorderid"].Value %>">
        <input type="hidden" name="fullname" value="<%=CurrentOrder.CustomerInfo.BillingAddress.FirstName +" "+CurrentOrder.CustomerInfo.BillingAddress.FirstName%>">
        <input type="hidden" name="address1" value="<%=CurrentOrder.CustomerInfo.BillingAddress.Address1 %>">
        <input type="hidden" name="address2" value="<%=CurrentOrder.CustomerInfo.BillingAddress.Address2 %>">
        <input type="hidden" name="city" value="<%=CurrentOrder.CustomerInfo.BillingAddress.City %>">
        <input type="hidden" name="state" value="<%=CurrentOrder.CustomerInfo.BillingAddress.StateProvinceName %>">
        <input type="hidden" name="postalcode" value="<%=CurrentOrder.CustomerInfo.BillingAddress.ZipPostalCode%>">
        <input type="hidden" name="country" value="<%=CurrentOrder.CustomerInfo.BillingAddress.CountryCode%>">
        <input type="hidden" name="email" value="<%=CurrentOrder.Email%>">
        <input type="hidden" name="phone" value="<%=CurrentOrder.CustomerInfo.BillingAddress.PhoneNumber%>">
        </form>
...
<uc:SiteCatalystPixel ID="SiteCatalystPixel1" runat="server" />
