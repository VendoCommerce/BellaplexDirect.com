<%@Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.AU.UserControls.BillingForm" CodeBehind="BillingForm.ascx.cs" %>
...
<asp:UpdatePanel ID="upBillingForm" runat="server">
    <ContentTemplate>
        <div class="cartA">
            <div>
                <img src="https://dd991rkqr6iba.cloudfront.net/Images/form-top.png" width="311" height="95" /></div>
            <div class="billing" style="background: url(https://dd991rkqr6iba.cloudfront.net/Images/form-bg.png) repeat-y; padding-left: 20px; padding-top: 9px;">
                    ...
                    <div class="form_line clearfix">
                        ...
                        <label class="label-1">
                            ...
                            <asp:TextBox ID="txtFirstName" TabIndex="100" MaxLength="14" CssClass="text-1"
                    ...
                    <div class="form_line clearfix">
                       ...
                       <label class="label-1">
                            ...
                            <asp:TextBox ID="txtLastName" TabIndex="101" MaxLength="14" CssClass="text-1"
                                runat="server"></asp:TextBox>
                    ...
                    <div class="form_line clearfix">
                        ...
                        <asp:TextBox ID="txtAddress2" TabIndex="103" MaxLength="100" runat="server"
                   ...
                   <label class="label-1">
                            ...
                            <asp:TextBox ID="txtCity" TabIndex="104" MaxLength="50" CssClass="text-1" runat="server"></asp:TextBox>
                   ...
                   <label class="label-1">
                    ...
                    <div class="form_line clearfix">
                     ...
                     <label class="label-1">
                            ...
                            <asp:TextBox ID="txtZipCode" TabIndex="106" runat="server" CssClass="text-1"
                    ...
                    <div class="form_line clearfix">
                      ...
                      <label class="label-1">
                            ...
                            <asp:TextBox ID="txtPhoneNumber2" MaxLength="3" TabIndex="110" CssClass="text-4"
                                runat="server"></asp:TextBox>
                            <asp:TextBox ID="txtPhoneNumber3" MaxLength="4" TabIndex="110" CssClass="text-4"
                                runat="server"></asp:TextBox>
                  ...
                  <label class="label-1">
                            ...
                            <asp:TextBox ID="txtEmail" TabIndex="110" CssClass="text-1" runat="server"
                                MaxLength="30"></asp:TextBox>
                        
                    </div>
               <div class="form_line clearfix" style="padding-bottom: 0">  <label class="label-1"></label>
                            <span class="respect" style="font-size: 10px">(We respect your privacy)</span>
</div>
                    <div class="form_line_btn">
                        <asp:Button ID="imgBtn" TabIndex="129" OnClick="imgBtn_OnClick" runat="server" CssClass="btn-form" />
                        <span style="font-size: 10px"><a href="terms/offers.aspx" class="popup" style="color: #000">
                            Terms and Conditions</a></span>
                    </div>
                
            </div>
            <div style="position: relative;">
                <img src="https://dd991rkqr6iba.cloudfront.net/Images/form-bottom.png" /></div>
        </div>
    </ContentTemplate>
</asp:UpdatePanel>
