...
namespace CSWeb.Admin
{
    public partial class VersionReport : BasePage
    {
        ...
        protected void BindData(DateTime? startDate, DateTime? endDate)
        {
            ...
            Data rptData = new ReportWSSoapClient().GetDataFromTimeframe(
                ConfigHelper.ReadAppSetting("HitsLinkUser"),
                ConfigHelper.ReadAppSetting("HitsLinkPassword"),                
                ReportsEnum.MultiVariate, TimeFrameEnum.Daily, Convert.ToDateTime(startDate), Convert.ToDateTime(endDate), 100000000, 0, 0);
