<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MIdReport.aspx.cs" Inherits="CSWeb.Admin.MIdReport"
...
<head id="Head1" runat="server">
    ...
    <title>My-No-No.com - MID Report</title>
        ...
        <div id="header2">
            ...
            <div id="report_nav">
                <a href="VersionReport.aspx">Version Report </a>| <a href="Reports.aspx">Standard
                    Report</a> | <span class="current">MID Report</span> |  <a href="TransactionReport.aspx">
                    Transaction History Report</a> |  <a href="PromoCodeDetail.aspx"> PromoCode Detail Report</a> | <a href="PromoCodeSummary.aspx">PromoCode Summary Report </a>
            </div>
        </div>
        <!-- end header -->
        <div id="main2">
