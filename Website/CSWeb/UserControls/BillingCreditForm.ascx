<%@Control Language="C#" AutoEventWireup="true" CodeBehind="BillingCreditForm.ascx.cs" Inherits="CSWeb.Root.UserControls.BillingCreditForm" %>
...
<h1 class="underline" style="font-size: 20px; padding-top: 6px;"> Shipping Details</h1>
<img class="postal" alt="United states postal service" src="https://d37t4f22sfrbdk.cloudfront.net/Images/ups.png" style="padding: 8px 0 0 0;">

          <p class="shipDate" style="padding: 0 0 20px 0"><%=DateTime.Today.AddDays(3).ToString("MMMM d") %></p></span>
<img width="275" height="151" alt="Please proceed with payment information" src="https://d37t4f22sfrbdk.cloudfront.net/Images/co-top.png">
        <div class="cartB">
            ...
            <div class="agree-terms">
             <div class="error-2"> <asp:Label ID="lblTerms" runat="server" Visible="false"></asp:Label></div>   
              ...
              <asp:CheckBox ID="cbTeams" runat="server" />     
                    ...
                    YES, I am 18 years old and agree to the <a href="javascript:;" onclick="window.open('terms/returns.aspx','return','width=700,height=650'); return false;">terms and conditions</a>                    
                 </label>
