...
<asp:UpdatePanel ID="upShippingForm" runat="server">
    <ContentTemplate>
        <div class="checkout_right">
            <span style="text-align: center">
                <h1 class="underline">
                    Shipping Details</h1>
                <img class="postal" width="272" height="46" alt="United states postal service" src="https://dd991rkqr6iba.cloudfront.net/Images/postal_cc.png">
                <h3 class="shipdateHead">
                    Estimated Ship Date:</h3>
                <p class="shipDate">
                    <%=DateTime.Today.AddDays(3).ToString("MMMM d") %></p>
            </span>
            <img width="275" height="132" alt="Please proceed with payment information" src="https://dd991rkqr6iba.cloudfront.net/Images/form-top_cc.png">
            <div class="cartB">
              
                    <div class="form_line clearfix" style="margin-left: 6px; text-align:center;">
                        <img src="https://dd991rkqr6iba.cloudfront.net/Images/credit-cards_cc.jpg" width="143"
                            height="68" alt="Credit Cards" />
    ...
    <div class="clear"></div>
        ...
        <img src="https://dd991rkqr6iba.cloudfront.net/Images/form-bottom_cc.png" width="275"
            height="95" alt="Safe and secure transactions" />
                </div>   </div>
