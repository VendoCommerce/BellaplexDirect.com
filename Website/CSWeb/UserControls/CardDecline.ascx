<%@Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.Root.UserControls.CardDecline" CodeBehind="CardDecline.ascx.cs" %>
...
<asp:UpdatePanel ID="upShippingForm" runat="server">
    ...
    <div id="receipt_content" style="height: auto; width: 875px; position: relative;
        ...
        <p style="color: Red; padding-bottom: 20px; font-size: 15px; font-weight: bold;">We're sorry. We were unable to process your order. Please check your payment details below and try again.</p>
    ...
    <asp:RadioButtonList ID="rblUpdateShippingAddress" runat="server" OnSelectedIndexChanged="rblUpdateShippingAddress_CheckedChanged"
        ...
        <asp:Panel ID="pnlShippingAddress" runat="server" Visible="false">
            ...
            <div class="form_line clearfix">
                ...
                <asp:TextBox ID="txtShippingAddress1" runat="server" MaxLength="100" CssClass="text-1"></asp:TextBox>
            </div>            
            <div class="form_line clearfix">
                <div class="error-1">
                </div>
                ...
                <asp:TextBox ID="txtShippingAddress2" runat="server" MaxLength="100" CssClass="text-1"></asp:TextBox>
            </div>
            <div class="form_line clearfix">
                <div class="error-1">
        ...
        <asp:ListItem Value="false" Selected="True">No</asp:ListItem>
            ...
            <asp:Panel ID="pnlBillingAddress" runat="server" Visible="false">
                ...
                <div class="form_line clearfix">
                    ...
                    <asp:TextBox ID="txtAddress1" runat="server" MaxLength="100" CssClass="text-1"></asp:TextBox>
                </div>
                <div class="form_line clearfix">
                    <div class="error-1">
                    </div>
                    ...
                    <asp:TextBox ID="txtAddress2" runat="server" MaxLength="100" CssClass="text-1"></asp:TextBox>
                </div>
                <div class="form_line clearfix">
                    <div class="error-1">
            ...
            <div class="form_line clearfix">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td><asp:TextBox ID="txtCCNumber1" runat="server" CssClass="text-2" MaxLength="16"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtCCNumber1" runat="server" Display="Dynamic" ErrorMessage="*" /></td>
