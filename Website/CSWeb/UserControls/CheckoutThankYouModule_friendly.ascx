<%@ Control Language="C#" Inherits="CSWeb.Root.UserControls.CheckoutThankYouModule_friendly" %>
...
<div id="stretch_container">
    <div id="receipt_content" style="height: auto; width: 884px; position: relative;
        ...
        <p style="font-size: 28px; padding-bottom: 20px; color: #000000">Congratulations and Thank You for Trying Bellaplex!</p>
        <p style="padding-bottom: 20px; color: #515151"><strong>We know you're going to love the same visible results that thousands of men and women nationwide have already experienced!</strong></p>
        <asp:Panel ID="PanelMultiPay" runat="server">
        <p style="padding-bottom: 20px; color: #515151">WITH YOUR 2 RISK FREE BOTTLES TODAY, YOU GET DISCOUNTED SHIPPING AND PROCESSING of just $1.99 billed to your card today!  With our 30 Day Money Back Guarantee, if you're not completely satisfied, you can call within 30 days of receipt to cancel and return the product as instructed and will not be billed any additional amount. If you decide to keep the bottles, you will be billed in two easy payments of $69.95, the first 30 days and second payment 60 days following receipt of trial shipment. </p>
        <p style="padding-bottom: 20px; color: #515151">Then unless you cancel, you will continue to receive a fresh 60 day supply every 2 months with the same guaranteed low price of just $69.95 per month plus $6.95 S&amp;P per shipment which will be conveniently billed to the card you provided today. By clicking &quot;Send My Trial&quot;, you authorize us to charge your card for each 2 bottle shipment per the terms described above. There is no commitment to continue and no minimum purchase. </p>
        <p style="padding-bottom: 20px; color: #515151">You can call customer service at 1-800-515-1070 at any time to cancel. Each shipment you receive is covered by the same 30-day Money Back Guarantee, just call within 30 days and return the product within two weeks for a full refund of the purchase price!</p>
        </asp:Panel>
        <asp:Panel ID="PanelOnePay" runat="server" Visible="false">
        <p style="padding-bottom: 20px; color: #515151">We are sending you 3 bottles of Bellaplex for the low price of $139.90 charged today to the card you provided. If you like your product and want to continue to see results, you don't have to do anything else.</p>
        <p style="padding-bottom: 20px; color: #515151">As a member of our Beauty Auto Ship Program and to ensure you continue to see results without running out of Bellaplex, we'll send you 3 bottles every 90 days for the price of 2—so you'll always get one FREE—until you tell us to stop! You authorize that the card you provided today will automatically be charged the low price of $139.90 and a small shipping and processing fee of $7.95 for each shipment, on the day your order ships. And remember—we waived your initial shipping and processing fee - and with every 2 bottles you'll always get 1 FREE! All NJ residents will be charged sales tax. Customers can call to cancel future shipments at any time.</p>
        <p style="padding-bottom: 20px; color: #515151">Remember, you have our 30-Day Bottom-of-the-Bottle Guarantee with each shipment. If you are not completely delighted with Bellaplex, call Customer Service at 1-800-515-1070 within 30 days of receipt of your shipment to request a return number and return 2 of the containers of Bellaplex within two weeks—even if they are empty—to avoid future shipments and for a full refund of the product-purchase price, less the shipping and processing. Please include your return number with your return package. Customer is responsible for return shipping.<br /></p>
        <p style="padding-bottom: 20px; color: #515151">For questions about your order, call 1-800-515-1070 Monday - Sunday from 8am - 10pm US EST or email.</p>
